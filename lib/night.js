...
})(window, function(__WEBPACK_EXTERNAL_MODULE_suncalc__) {
...
/* harmony import */ var _night__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./night */ "./src/night.js");

/* harmony default export */ __webpack_exports__["default"] = (_night__WEBPACK_IMPORTED_MODULE_0__["default"]);
  ...
  _createClass(Night, [{
    ...
    value: function settings(_settings) {
      ...
      for (var setting in defaults) {
        if (setting in _settings) custom[setting] = _settings[setting];else custom[setting] = defaults[setting];
      }
